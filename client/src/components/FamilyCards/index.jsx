                    ...
                    <div className="modal-body p-4">
                        <ul className="nav nav-pills nav-justified mb-3" id="ex1" role="tablist">
                            <li className="nav-item" role="presentation" onClick={tabChangeHandler}>
                                <a className="nav-link"  data-mdb-pill-init="" href="#pills-create-family" role="tab" aria-controls="pills-create-family" aria-selected="true" data-mdb-tab-initialized="true" id="mdb-tab-create-family">Create family</a>
                            </li>
                            <li className="nav-item" role="presentation" onClick={tabChangeHandler} >
                                <a className="nav-link active"  data-mdb-pill-init="" href="#pills-search-family" role="tab" aria-controls="pills-search-family" aria-selected="false" data-mdb-tab-initialized="true" tabIndex="-1" id="mdb-tab-search-family">Search family</a>
                            </li>
                        </ul>
